    ...
    'snippets': [
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
                        '<div class="display">' +
			    		'<h1 style="text-transform: uppercase;">Beautiful Content. Responsive.</h1>' +
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/images/lamp.png" alt="">' +
					'</div>' +
					'<div class="column half" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">' +
						'<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/images/office1.png" alt="">' +
					'</div>' +
				'</div>'
		},
		{
		...
		*/
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
                        '<div class="display">' +
                        '<p>Creative Studio</p>' +
			    		'<h1>We Create & Design Beautiful Websites</h1>' +
                        '</div>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full padding-50" style="text-align: center;">' +
						'<p style="text-align: center; letter-spacing: 11px; text-transform: uppercase;">Hello Friends</p>' +
						'<h1 style="letter-spacing: 3px; text-align: center;">This is Dave. I Develop Websites and Design Beautiful Things You Will Love.</h1>' +
						'<div class="spacer height-40"></div><span><a href="#" class="is-btn is-btn-ghost1 is-upper is-rounded-30 is-btn-small edit">Contact Me</a></span>' +
					'</div>' +
				'</div>'
		},
        ...
        /* Circular Image */
		{
			...
			'html':
				'<div class="row clearfix">' +
					'<div class="center column half" style="display: flex; flex-direction: column; justify-content: center; align-items: flex-start;">' +
			...
			'html':
				'<div class="row clearfix">' +
					'<div class="column half" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">' +
						'<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.</p>' +
					'</div>' +
					'<div class="column half center" style="display: flex; flex-direction: column; justify-content: center; align-items: flex-end;">' +
						'<div class="img-circular" style="margin:25px 0;width:270px;height:270px"><img src="assets/minimalist-blocks/images/oleg-laptev-545268-unsplash-VD7ll2.jpg" alt=""></div>' +
					'</div>' +
				'</div>'
		},
		...
		*/
		...
		/* Video */
		{
			...
			'html':
					...
					'<source src="assets/minimalist-blocks/example.mp4" type="video/mp4"></video>'
			},
                ...
                '<div class="row clearfix">' +
                    '<div class="column full padding-0 is-light-text" data-noedit data-module="slider-builder" data-module-desc="Slider" data-html="' +
                        ...
                        '{' +
                            ...
                            '"dots":false,' +
							'"fit":""' +
                        '}') + '" style="background-image:linear-gradient(30deg, rgb(249, 119, 148), rgb(98, 58, 162));">' +
...

		{
		    ...
		    'html':
				...
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column fifth" style="background-color: rgb(250, 250, 250);">' +
						'<h1 class="size-46" style="line-height: 2.5; text-align: center; font-family: courier;">90%</h1>' +
					'</div>' +
					'<div class="column two-fifth" style="background-color: rgb(250, 250, 250);">' +
						'<p style="text-align: justify;"><b>UI/UX</b><br>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type.</p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-fifth" style="background-color: rgb(250, 250, 250);">' +
						'<p style="text-align: justify;"><b>Explainer Video Animation</b><br>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type.</p>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div class="size-28" style="font-weight: bold; position: absolute; left:0; top:3px; line-height: 1;">355</div>' +
							_tabs(1) + '<h2 class="size-28">Happy Clients</h2>' +
							_tabs(1) + '<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div class="size-28" style="font-weight: bold; position: absolute; left:0; top:3px; line-height: 1;">70+</div>' +
							_tabs(1) + '<h2 class="size-28">Projects Done</h2>' +
							_tabs(1) + '<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div class="size-28" style="font-weight: bold; position: absolute; left:0; top:3px; line-height: 1;">30</div>' +
							_tabs(1) + '<h2 class="size-28">Awards Won</h2>' +
							_tabs(1) + '<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div class="size-28" style="font-weight: bold; position: absolute; left:0; top:3px; line-height: 1;">19k</div>' +
							_tabs(1) + '<h2 class="size-28">Followers</h2>' +
							_tabs(1) + '<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
				'</div>'
